...
moduleForModel('i-i-s-novyjj-proekt-2-регистр-оборот', 'Unit | Serializer | i-i-s-novyjj-proekt-2-регистр-оборот', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-novyjj-proekt-2-регистр-оборот',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
