...
moduleForModel('i-i-s-novyjj-proekt-2-перечень-товаров', 'Unit | Serializer | i-i-s-novyjj-proekt-2-перечень-товаров', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-novyjj-proekt-2-перечень-товаров',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
